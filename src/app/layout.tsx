...
export const metadata: Metadata = {
  ...
  description:
    "5xSME is a Bengaluru & Mangaluru based marketing and technology agency for small and medium businesses — ads, social media, videography, SEO, and app development under one team.",
  openGraph: {
    type: "website",
    locale: "en_IN",
    siteName: "5xSME",
